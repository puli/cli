...
namespace Puli\Cli\Tests\Console\Descriptor;
...
use Puli\Cli\Console\Descriptor\DefaultDescriptor;
use Puli\Cli\Console\Process\ProcessLauncher;
use Puli\Cli\Console\Style\NeptunStyle;
use Puli\Cli\Tests\Console\Fixtures\TestApplication;
use Puli\Cli\Tests\Console\Fixtures\TestPackageAddCommand;
use Puli\Cli\Tests\Console\Fixtures\TestPackageCommand;
use Puli\Cli\Tests\Console\Fixtures\TestSynopsisCommand;
...
class DefaultDescriptorTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->executableFinder = $this->getMockBuilder('Symfony\Component\Process\ExecutableFinder')
            ...
            ->getMock();
        $this->processLauncher = $this->getMockBuilder('Puli\Cli\Console\Process\ProcessLauncher')
            ->disableOriginalConstructor()
            ->getMock();
