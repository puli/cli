...
namespace Puli\Cli\Tests\Console\Api\Input;

use PHPUnit_Framework_TestCase;
use Puli\Cli\Console\Api\Input\InputOption;
...
class InputOptionTest extends PHPUnit_Framework_TestCase
{
    ...
    /**
     * @expectedException \Puli\Cli\Console\Api\Input\InvalidDefaultValueException
     */
